...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/jezzmemo/StockView.git"
  ...
  s.source       = { :git => "https://github.com/jezzmemo/StockView.git", :tag => s.version.to_s }
  ...
  s.source_files  = "StockView/Source/*.{h,m}"
