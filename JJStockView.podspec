...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    iOS股票表格控件,支持左右滑动和上下滑动
                   DESC

  s.homepage     = "https://github.com/jezzmemo/JJStockView.git"
  ...
  s.source       = { :git => "https://github.com/jezzmemo/JJStockView.git", :tag => s.version.to_s }
  ...
  s.source_files  = "JJStockView/Source/*.{h,m}"
